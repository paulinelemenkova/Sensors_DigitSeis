...
The length distribution of the segments imported is represented in Fig. \ref{fig:21}, the peak correspond to the typical frequent segment length $S_{typ}$ (approximately 1415 pixels in our setup for one minute of recording).
...
\begin{figure}[H]
     ...
     \begin{subfigure}[H]{0.7\textwidth}
      	\centering
         	\includegraphics[width=12.0cm]{fig_21a.png}
     ...
     \begin{subfigure}[H]{0.7\textwidth}
         \centering
        		 \includegraphics[width=12.0cm]{fig_21b.png}
        		 \caption{Analysis of statistics on segment length per hours of recording in Matplotlib}
     \end{subfigure}
     \caption{Validating the results of segments tracing in Python for selected seismogram. Here: UCC19540109Gal\_E\_0812} \label{fig:21}
\end{figure}
...
\begin{figure}[H]
     ...
     \begin{subfigure}[H]{0.7\textwidth}
      	\centering
         	\includegraphics[width=12.0cm]{fig_22a.png}
         	\caption{Frequency of segment length visualized in Matplotlib: size of various segments in a trace}
     \end{subfigure}
     \vspace{1mm}   
     ...
     \begin{subfigure}[H]{0.7\textwidth}
         \centering
        		 \includegraphics[width=12.0cm]{fig_22b.png}
        		 \caption{Analysis of statistics on segment length per hours of recording in Matplotlib}
     \end{subfigure}
     \caption{Validating the results of segments tracing in Python for selected seismogram. Here: UCC19540311Gal\_E\_0727\_280.mat} \label{fig:22}
\end{figure}

Fig. \ref{fig:21} illustrate the analysis of the performance of DigitSeis in vectorising segments of a trace: the average length of the segment identified by the program as 'trace' and the frequency of the segments per hour.  
