...
\begin{figure}[H]
     ...
     \begin{subfigure}[h]{0.7\textwidth}
      	\centering
         	\includegraphics[width=13.0cm]{Fig_UCC19540106Gal_N_0811.jpg}
         	\caption{Broken lines between seismic traces}
     \end{subfigure}
     
     \vspace{3mm}
     \begin{subfigure}[h]{0.7\textwidth}
         \centering
        		 \includegraphics[width=13.0cm]{Fig_UCC19540107Gal_N_0815.jpg}
        		 \caption{Partially spotted image}
     \end{subfigure}
          
     \vspace{3mm}
     \begin{subfigure}[h]{0.7\textwidth}
         \centering
        		 \includegraphics[width=13.0cm]{Fig_UCC19540108Gal_N_0815.jpg}
        		 \caption{Noise dark background on the image}
     \end{subfigure}
     
      \vspace{3mm}
     \begin{subfigure}[h]{0.7\textwidth}
         \centering
        		 \includegraphics[width=13.0cm]{Fig_UCC19540112Gal_E_0750.jpg}
        		 \caption{Overlapped traces}
     \end{subfigure}
     \caption{Examples of the raw data: old analog seismograms recorded by Uccle seismic station, Belgium, 1954, scanned and saved as TIFF files. Some images have visible distortions and defects.} \label{fig:1}
\end{figure}
...
\begin{figure}[H]
     ...
     \end{subfigure}
     \caption{Results of the paper seismogram classification processed by DigitSeis} \label{fig:3}
\end{figure}

\subsubsection{Classification}
Using DigitSeis classification tool we automatically converted the image from raster TIFF file into the vector objects in a binary format which was done based upon partition of pixels to 0-1 categories. Combining some segments of the traces was done using the crosshairs (Fig. \ref{fig:3}). The classification settings were adjusted using the Classify Objects function of DigitSeis, in order to make the automated processing smooth and accurate (Fig. \ref{Fig:4}). 
