...
\begin{figure}[H]
     ...
     \begin{subfigure}[h]{0.7\textwidth}
      	\centering
         	...
         	\caption{Fragment of the classified seismogram with shown identified object categories: traces (white) and noise (red, here: handwritten annotations)}
     \end{subfigure}
     \vspace{3mm}   
...
\begin{figure}[H]
     ...
     \begin{subfigure}[h]{0.7\textwidth}
      	\centering
         	...
         	\caption{Enlarged fragment of the classified image with shown yellow segments of trace to be merged}
     \end{subfigure}
     \vspace{3mm}   
...
To ensure the detailed selection of objects and make a closer analysis of a selected parts of the seismogram, the 'Small Region Analysis' function was applied, Fig. \ref{fig:8}. As a result, traces, time gaps, and noise were all classified more accurately as a prerequisite for the next step of digitising. 

\subsubsection{Digitizing}
In order to make the digitising workflow more effective, the images were cropped to minimise space and time of data processing. 
...
\begin{figure}[H]
     ...
     \begin{subfigure}[h]{0.7\textwidth}
      	\centering
         	...
         	\caption{Digitised traces upon completion of the automated vectorisation by DigitSeis}
     \end{subfigure}
     \vspace{3mm}   
     ...
     \begin{subfigure}[h]{0.7\textwidth}
         \centering
        		 ...
        		 \caption{Enlarged view of the automatically recognised digitised traces displayed by lines of various colours and time gaps (vertical yellow dashes)}
     \end{subfigure}
