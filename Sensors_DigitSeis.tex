...
The study was performed in the Université Libre de Bruxelles, École polytechnique de Bruxelles, Laboratory of Image Synthesis and Analysis (LISA), Belgium. We used archives obtained as a courtesy of \ac{ROB}, Department of Seismology \& Gravimetry, \ac{UCC}, Fig. \ref{fig:01}. The process is done within the framework of the SeismoStorm project.
