...
\Title{\highlighting{Computer} %MDPI: !!!Dear author, please reply all %MDPI: comment, Thanks!!!
...
\Author{\hl{Polina Lemenkova} %Please carefully check the accuracy of names and affiliations. 
...
\AuthorCitation{Lemenkova, P.; \hl{De Plaen,} %MDPI: Please confirm the surname.
 R.; Lecocq, T.; Debeir, O.}


% Affiliations / Addresses (Add [1] after \address if there is only one affiliation.)
\address{%
$^{1}$ \quad Laboratory of Image Synthesis and Analysis (LISA), École Polytechnique de Bruxelles {(Brussels Faculty of Engineering),} Université Libre de Bruxelles (ULB), Building L, {Campus}  de Solbosch, Avenue Franklin Roosevelt 50, \hl{1000} %MDPI: please confirm if the postcode is correct. They must have the same format for the same country and city.
 Brussels, Belgium; {olivier.debeir@ulb.be}
\\
$^{2}$ \quad Royal Observatory of Belgium, Seismology \& Gravimetry (OD2), \hl{Av.} %MDPI: Please confirm if this should be changed into Avenue.
 Circulaire 3, \hl{BE-1180} %MDPI: Please confirm if this is the postcode, we moved it before the municipality and please keep the same format of the post code for same country 
\hl{Uccle,} %MDPI: Please confirm if the city is correct.
 Belgium; raphael.deplaen@gmail.com (R.D.P.); \hl{t}homas.\hl{l}ecocq@seismology.be (T.L.)}%MDPI: We changed to lowercase.
...
The first attempts to digitise the analogue recordings of seismic events {and convert the data }into numeric format started in 1960s. An \hl{ad hoc} %MDPI: We removed italic. please confirm
...
\begin{figure}[H]
  ...
  \caption{\hl{Threshold} %MDPI: Please change hyphen into minus if it's possible.
...
We arbitrarily keep as valid the segment inside the \hl{range} %MDPI: We added 0 in front of .8.
 \highlighting{$[0.8*S_{typ},1.1*S_{typ}]$}%MDPI: if the * need change to multiplication sign ×, please confirm
. The starting position of these segments is represented as {the }green dots in Figure \ref{fig:20}a. 
From the distribution of {the }short invalid segments, as {shown }in Figure \ref{fig:20}a, we can identify{ }small segments corresponding to the typical hours marks length $H_{typ}$ (around 210 pixels here). The valid hours marks are considered in the range \hl{$[0.9*H_{typ},1.1*H_{typ}]$}%MDPI: if the * need change to multiplication sign ×, please confirm
...
\funding{\hl{This} %MDPI: Please check the accuracy of funding data and any other information carefully.
...
\noindent 
\begin{tabular}{@{}ll}
\hl{GPS} %MDPI: We removed bold and added the information confirm Abbrev.tex.
...
\newblock\hl{ reprinted, Stechert-Haffner, 1965.} %MDPI: Please confirm if this information is necessary. Please integrate the extra information into the reference if the information should be kept. Please add publisher's location, for example (for Stechert-Haffner)
...
Ud\'{i}as, A.; Buforn, E.
\newblock {\em Principles of Seismology}, 2nd ed.; Cambridge University Press: \hl{Cambridge, UK,} %MDPI: Newly added information.
...
\newblock In {\em Seismic Ambient Noise}; Cambridge University Press: \hl{Cambridge, UK, } 2019; pp. xx--xxviii. {https://doi.org/10.1017/9781108264808.002}. %MDPI: Newly added information.
...
\newblock {\em Bull. Seismol. Soc. Am.} {\bf 1979},
  {\em 11},~64--70.
\newblock \hl{Earthquake Information Bulletin (USGS).} %MDPI: Can this information be removed?
...
\newblock History of seismology. In {\em International Handbook of Earthquake
  ...
  pp. 3--12; \hl{Part A} %MDPI: Please confirm if it is unnecessary and can be removed.
.
...
\newblock 88---Old Seismic Bulletins to 1920: A Collective Heritage from Early
  ...
  Eds.; Academic Press: \hl{San Diego, CA, USA,}  2003; Volume~81, pp.
  1665--1723. {https://doi.org/10.1016/S0074-6142(03)80300-5}. %MDPI: Newly added information.
...
\newblock \hl{Rescuing Legacy Data for Future Science.} %MDPI: Is this information necessary?
...
\newblock Global seismicity: 1900--1999. In {\em International Handbook of
  ...
  2002; \hl{Volume Part A,} %MDPI: Please confirm volume number.
pp. 665--690.
...
Ammon, C.J.; Velasco, A.A.; Lay, T.; Wallace, T.C., Seismogram interpretation
  and processing.
\newblock In {\em Foundations of Modern Global Seismology}, 2nd ed.; Elsevier:  \hl{Amsterdam, The Netherlands,} %newly added information, please confirm
...
\newblock \hl{cp1--cp2.} %MDPI: Is this information necessary?
...
\newblock {\em Geochem. Geophys. Geosyst.} {\bf 2010}, \highlighting{{\em 11}.} %MDPI: Please add page number.
...
\newblock Hierarchical exploration of continuous seismograms with unsupervised
  learning.
\newblock {\em Earth Space Sci. Open Arch.} {\bf 2021}, \hl{\emph{127}, e2021JB022455.} %MDPI: Information revised.
\newblock
...
Lomnitz, C.
\newblock {\em Fundamentals of Earthquake Prediction}; Wiley:  \hl{Hoboken, NJ, USA,} %newly added information, please confirm
  1994.
...
\newblock Monitoring southwest \hl{Greenland's } %MDPI: The word was revised.
...
\newblock {\em Nat. Commun.} {\bf 2021}, {\em 12}, \hl{4211.}
\newblock
...
\newblock {\em Nature} {\bf 2000}, {\em 405}, \hl{938--941.}
\newblock
...
\newblock {\em J. Geophys. Res. Ocean.} {\bf 2011}, \highlighting{{\em 116}.} %MDPI: Please add page number.
...
\newblock {Distributed sensing of microseisms and teleseisms with submarine
  dark fibers}.
\newblock {\em Nat. Commun.} {\bf 2019}, {\em 10}, \hl{5778.}
\newblock
...
\newblock In {\em Seismic Activity in Western Europe with Particular
  ...
  Sciences; Springer:  \hl{Berlin/Heidelberg, Germany,} %newly added information, please confirm
  1985;
...
\newblock Observatoire Royal de Belgique: \hl{Uccle, Belgium, } %MDPI: Newly added information.
1990; pp. 1--267.
...
\newblock Digitalizing Seismograms Using a Neighborhood Backtracking Method. 
 In \emph{Proceedings of the International Conference on Knowledge Science, Engineering and
  Management (KSEM 2016), \hl{Passau, Germany, 5--7 October 2016}}; Lehner, F.;
...
\newblock In {\em Earth Observation Using Python}; American Geophysical Union
  (AGU): \hl{Washington, DC, USA, } 2021; Chapter~4, pp. 45--66.
\newblock
...
\newblock  In Proceedings of the 2019 Fifth International Conference on Advances in Biomedical
  Engineering (ICABME), \hl{Tripoli, Lebanon, 17--19 October 2019;} pp. 1--3.
\newblock
...
\newblock  In Proceedings of the 2008 5th IEEE International Symposium on Biomedical Imaging: From
  Nano to Macro,  \hl{Paris, France, 14--17 May 2008;} pp. 724--727.
\newblock
...
\newblock  In Proceedings of the 2019 IEEE 16th International Symposium on Biomedical Imaging (ISBI
  2019),  \hl{Venice, Italy, 8--11 April 2019;} pp. 1869--1872.
\newblock
...
\hl{Somville, O.} %MDPI: please confirm if Refs. 98 and 99 are  same.  if yes,  please replace or delete the duplicated reference. If one of them is deleted, please update the reference list as well as reference order in the whole text. Please make sure the first citation of all references are mentioned in numerical order.
\newblock {\em Constantes des Sismographes Galitzine}; Annales de l’Observatoire Royal de Belgique: \hl{Uccle, Belgium,} 1922; Volume 1.

\bibitem[Somville(1922{\natexlab{b}})]{Somville1922b}
\hl{Somville, O.}
\newblock {\emph{Sur la Methode d’Enregistrement Galvanometrique Appliquee aux
  Sismographes Galitzine}};  Annales de l’Observatoire Royal de Belgique: \hl{Uccle, Belgium,} 1922; Volume 1.
...
\newblock In {\em Proceedings of the American Mathematical Society}; \hl{American Mathematical Society: Providence, RI, USA, }1953; Volume 4; pp. 502--506.
\newblock \hl{JSTOR 2032161, MR 0055639,} %MDPI: Can this information be deleted?
