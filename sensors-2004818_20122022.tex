...
We used the DigitSeis software of version 1.5, developed by Bogiatzis, P. and Ishii, M. from the Department of Earth and Planetary Sciences, Harvard University, Cambridge, U.S.A. %MDPI: Please state the software version number, creator, and the location (city, country) from where the software was sourced. <-- Authors: information added as follows: version -- v1.5, creator -- Bogiatzis, P. and Ishii, M. from the Department of Earth and Planetary Sciences, Harvard University, location -- Cambridge, U.S.A. 
