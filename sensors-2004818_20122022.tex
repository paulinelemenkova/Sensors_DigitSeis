...
\setcounter{subfigure}{1}
     ...
     \end{subfigure}
     \vspace{3mm}
     \caption{\hl{Seismogram} %MDPI: 1.  many numbers in The left and right  of subfigure ``a,b,c'' is incomplete .  please replace a shaper picture. <-- Authors: Figures 18a, 18b and 18c are replaced with original files with sharper resolution and corrected left and right annotations.
...
\begin{figure}[H]
     ...
     \begin{subfigure}[H]{0.7\textwidth}
        		 ...
        		 \caption{}
     \end{subfigure}
     \caption{Controlling %MDPI: 1. Please use commas to separate thousands for numbers with five or more digits (not for four digits) in the picture. e.g., "10000" should be "10,000" <-- Authors: Figures 20a and 20b are replotted with used commas to separate thousands for numbers with five or more digits. Added explanation for different color dots: Different color dots are used to separate minute marks (green), hour marks (blue) and margin values and outliers (red).
