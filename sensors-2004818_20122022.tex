...
\setcounter{subfigure}{1}
     \begin{subfigure}[h]{0.7\textwidth}
        		 ...
        		 \caption{}
     \end{subfigure}
     \caption{\hl{Correcting} %MDPI: The top of subfigure a seem incomplete, please revise. <-- Authors: Figure 15a is replotted.
...
\begin{figure}[H]
     \begin{subfigure}[H]{0.7\textwidth}
         	\includegraphics[width=12.0cm]{fig_20a.jpg}
         	\caption{}
     \end{subfigure}
     \vspace{1mm}   

     \begin{subfigure}[H]{0.7\textwidth}
        		 \includegraphics[width=12.0cm]{fig_20b.jpg}
        		 \caption{}
     \end{subfigure}
