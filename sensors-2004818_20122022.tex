...
\begin{figure}[H]
     ...
     \end{subfigure} 
     \vspace{3pt}
     \caption{\hl{Results}  %MDPI: 1.  many numbers in The left and right  of subfigure ``a'' is incomplete .  please replace a shaper picture. <-- Authors: Figure 12a is replotted with corrected X- and Y annotations. A figure is replaced with original file with 300 dpi resolution. 
...
\setcounter{subfigure}{1}
     \begin{subfigure}[h]{0.7\textwidth}
        		 ...
        		 \caption{}
     \end{subfigure}
     \caption{\hl{Correcting} %MDPI: The top of subfigure a seem incomplete, please revise. <-- Authors: Figure 15a is replotted with added X-axis on top of the figure.
